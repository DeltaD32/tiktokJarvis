...
export function TopStrip({ state, cost, noticeCount, agentCount, connected, input, setInput, onSend }) {
    ...
    <div className="top-strip">
      ...
      <div className="top-strip-stats">
        ...
        <div className="stat-block">
          <div className="stat-value">{agentCount}<span className="stat-unit"> agents</span></div>
